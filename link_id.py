def link_id(ids, ep_act = 'V25A2'):
    ...
    ids = str(ids)
    ids = ids.replace("#","%23")
    ep_act_code = episode[ep_act]
    link = f'https://tracker.gg/valorant/profile/riot/{ids}/overview?platform=pc&playlist=competitive&season={ep_act_code}'
    return link